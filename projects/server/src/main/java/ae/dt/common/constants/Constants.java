...
public class Constants {
	...
	public enum BOL_STATUS {
		...
		DELETED("DELETED", "DELETED"), BOL_INITIATED("BOL_INITIATED", "BOL_INITIATED"), REJECTED("REJECTED","REJECTED"),CANCELLED("CANCELLED","CANCELLED");
	...
	public enum INVOICE_TYPE {
		...
		DETENTION_CHARGES("Detention Invoice", ""), OTHER("Other", "");
	...
	public enum EMAIL_TYPE {
		DO_REQUEST_SA("DO_REQUEST_SA"), DO_REQUEST_BOL("DO_REQUEST_BOL"), DO_REQUEST_DO("DO_REQUEST_DO"),DO_REQUEST_PARTIAL_PAYMENT_DO("DO_REQUEST_PARTIAL_PAYMENT_DO"),DO_REQUEST_PARTIAL_PAYMENT_BOL("DO_REQUEST_PARTIAL_PAYMENT_BOL"),
		DO_REQUEST("DO_REQUEST"),NEW_DO_REQUEST("NEW_DO_REQUEST"),BOL_REQUEST("BOL_REQUEST"),INVOICE_REQUEST("INVOICE_REQUEST"),REJECT_RETURN_DO("REJECT_RETURN_DO"),UPLOAD_BOL("UPLOAD_BOL"),UPLOAD_BOL_SA("UPLOAD_BOL_SA"),
		UPLOAD_BOL_CONSIGNEE("UPLOAD_BOL_CONSIGNEE"),OTIFY_PAYMENT_OF_PROOF("NOTIFY_PAYMENT_OF_PROOF"),NEW_DO_REQUEST_SA("NEW_DO_REQUEST_SA");
	...
	public enum Approver_view {
		Y("Y"), N("N");

		public String value;

		private Approver_view(String value) {
			this.value = value;
		}
	}
}
